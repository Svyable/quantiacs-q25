...
Frontier-L pivots away from failed residual-correlation graph mining into distributional sequence structure, cross-sectional activity-share migration, and regime-conditioned relative value. 2023-2024 is spent and excluded.
