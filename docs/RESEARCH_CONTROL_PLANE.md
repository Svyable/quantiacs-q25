...
|---|---|---|---:|---:|---|
| `frontier_20260912n` | Frontier-N | FROZEN_UNMEASURED_OR_UNRECEIPTED | 1 | 5 | — |
...
- **P3 MEASURE_FROZEN_CAMPAIGN** `frontier_20260912n`: Frozen manifest is ahead of canonical evidence and has no committed measurement receipt.
