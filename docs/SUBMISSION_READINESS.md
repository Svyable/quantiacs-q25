...
Packaged artifacts: **3/3** · full-history 4%-ATR floor pass: **3/3** · frozen forward observed: **1** · public smoke clear: **2** · account-bound clear: **0**.
...
| **Lattice Consensus** | `PROMOTED_PENDING_FORWARD_AND_ACCOUNT_BOUND_CORRELATION` | yes | 1.460 | — | 1.056 | — | `NOT_RUN` | FROZEN_FORWARD_CONFIDENCE_NOT_MEASURED, ACCOUNT_BOUND_UNIQUENESS_CORRELATION |
