...
<div class="q25-shell" data-q25-dashboard>
  ...
  <section class="q25-section q25-section-tight">
    <div class="q25-section-head">
      <div>
        <div class="q25-kicker">Learning telemetry</div>
        <h2>Five feedback channels, zero mega-score</h2>
      </div>
      <p>These are diagnostics for recursive self-improvement. A “good” iteration can promote nothing if it decisively falsifies weak ideas or exposes stale assumptions.</p>
    </div>
    ...
    <div class="q25-metric-grid">
      ...
      <article class="q25-card q25-metric-card">
        ...
        <small>economics ∩ causal support; still not validation</small>
      </article>
      <article class="q25-card q25-metric-card">
  ...
  <section class="q25-section">
    <div class="q25-section-head">
      ...
      <p>Ranking is local to one comparable campaign. The causal margin is the central parent minus the stronger of its ablation and falsifier.</p>
    </div>
  ...
  <section class="q25-section">
    <div class="q25-section-head">
      <div>
        <div class="q25-kicker">Research loop</div>
        <h2>The system improves by increasing information per look</h2>
      </div>
    </div>
    <div class="q25-loop">
  ...
  <section class="q25-section q25-section-muted">
    ...
    <div class="q25-three-col">
      <article class="q25-card">
        <h3>Development</h3>
        <p>Research/dev folds, configured cost ladder, destructive controls, implementation integrity. Useful for selection pressure, never a production claim.</p>
      </article>
      <article class="q25-card">
