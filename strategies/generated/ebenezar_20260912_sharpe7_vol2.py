...
def _run_backtest(strategy_fn):
    ...
    qnbt.backtest(competition_type=COMPETITION_TYPE, load_data=load_data, lookback_period=LOOKBACK_DAYS, start_date="2016-01-01", strategy=strategy_fn, analyze=True, check_correlation=True)
