"""Trend-consistency alpha: reward assets whose positive return is distributed across weeks rather than one jump."""
import numpy as np
import xarray as xr
COMPETITION_TYPE="crypto_daily_long"; STRATEGY_ID="q25_trend_consistency_v1"; LOOKBACK_DAYS=180; NAME_CAP=.25; EPS=1e-12
def calculate_weights(data):
 ...
 weekly=c/c.shift(time=7)-1; pos=xr.where(weekly>0,1.,0.).rolling(time=42,min_periods=28).mean()
